...
#include "qt/tutela/forms/ui_dashboardwidget.h"
#include "qt/tutela/sendconfirmdialog.h"
#include "qt/tutela/txrow.h"
...
DashboardWidget::DashboardWidget(TutelaGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of TUTL staked."));
    ...
    ui->labelAmountPiv->setText("0 TUTL");
    ...
    ui->btnHowTo->setText(tr("How to get TUTL"));
...
void DashboardWidget::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("TUTL")
    updateDisplayUnit();
}
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZTUTL;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair TUTL, zTUTL
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("TUTL");
    set1 = new QBarSet("zTUTL");
