...
#include "qt/tutela/coldstakingwidget.h"
#include "qt/tutela/forms/ui_coldstakingwidget.h"
#include "qt/tutela/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/tutela/requestdialog.h"
#include "qt/tutela/tooltipmenu.h"
...
ColdStakingWidget::ColdStakingWidget(TutelaGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your TUTLs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept TUTL delegation / Delegate TUTL"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select TUTL outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 TUTL" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
