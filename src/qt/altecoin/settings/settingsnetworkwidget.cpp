...
#include "qt/tutela/settings/settingsnetworkwidget.h"
#include "qt/tutela/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/tutela/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(TutelaGUI* _window, QWidget *parent) :
