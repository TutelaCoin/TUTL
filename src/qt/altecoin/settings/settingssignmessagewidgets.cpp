...
#include "qt/tutela/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(TutelaGUI* _window, QWidget *parent) :
