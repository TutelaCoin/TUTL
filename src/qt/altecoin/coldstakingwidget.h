...
#include "qt/tutela/furabstractlistitemdelegate.h"
#include "qt/tutela/txviewholder.h"
#include "qt/tutela/tooltipmenu.h"
#include "qt/tutela/sendmultirow.h"
#include "qt/tutela/coldstakingmodel.h"
#include "qt/tutela/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(TutelaGUI* parent);
    ~ColdStakingWidget();
