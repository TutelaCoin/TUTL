...
/** Utility functions used by the Tutela Qt UI.
 */
namespace GUIUtil
{
...
// Render Tutela addresses in monospace font
...
// Parse "tutela:" URI into recipient object, return true on successful parsing
