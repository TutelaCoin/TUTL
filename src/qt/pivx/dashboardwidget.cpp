    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of TUTL earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 TUTL");
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(181,242,255));
	set1->setColor(QColor(232,193,255));
