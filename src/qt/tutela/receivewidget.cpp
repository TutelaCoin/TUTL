...
#include "qt/tutela/forms/ui_receivewidget.h"
...
#include "qt/tutela/addressholder.h"
...
ReceiveWidget::ReceiveWidget(TutelaGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive TUTL."));
