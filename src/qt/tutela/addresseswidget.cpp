...
#include "qt/tutela/forms/ui_addresseswidget.h"
#include "qt/tutela/addresslabelrow.h"
#include "qt/tutela/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(TutelaGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter Tutela address"));
