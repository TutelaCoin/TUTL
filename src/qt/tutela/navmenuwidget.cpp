...
#include "qt/tutela/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(TutelaGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-tutela");
