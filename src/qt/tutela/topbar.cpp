...
#include "qt/tutela/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/tutela/lockunlock.h"
#include "qt/tutela/qtutils.h"
#include "qt/tutela/receivedialog.h"
...
TopBar::TopBar(TutelaGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("Tutela")
    updateDisplayUnit();
