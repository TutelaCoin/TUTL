...
#include "qt/tutela/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/tutela/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(TutelaGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to TutelaGUI::handleRestart()
