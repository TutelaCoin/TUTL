...
#include "qt/tutela/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/tutela/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(TutelaGUI* _window, QWidget *parent) :
