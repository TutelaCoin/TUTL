...
#include "qt/tutela/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/tutela/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(TutelaGUI* _window, QWidget *parent) :
