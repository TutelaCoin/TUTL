...
#include "qt/tutela/coincontrolpivwidget.h"
#include "qt/tutela/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select TUTL Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("TUTL");
    ...
    ui->labelValueAfter->setText("0.00 TUTL");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 TUTL");
    ui->labelValueFee->setText("0.00 TUTL");
