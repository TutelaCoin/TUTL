...
#ifndef Tutela_CORE_NEW_GUI_TutelaGUI_H
#define Tutela_CORE_NEW_GUI_TutelaGUI_H
...
#include "qt/tutela/navmenuwidget.h"
#include "qt/tutela/topbar.h"
#include "qt/tutela/dashboardwidget.h"
#include "qt/tutela/send.h"
#include "qt/tutela/receivewidget.h"
#include "qt/tutela/addresseswidget.h"
#include "qt/tutela/privacywidget.h"
#include "qt/tutela/coldstakingwidget.h"
#include "qt/tutela/masternodeswidget.h"
#include "qt/tutela/snackbar.h"
#include "qt/tutela/settings/settingswidget.h"
...
/**
  Tutela GUI main class. This class represents the main window of the Tutela UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TutelaGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TutelaGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~TutelaGUI();
...
#endif //Tutela_CORE_NEW_GUI_TutelaGUI_H
