 ...
 * Tutela system. There are three: the main network on which people trade goods
...
public:
    ...
    int TutelaBadBlockTime() const { return nTutelaBadBlockTime; }
    int TutelaBadBlocknBits() const { return nTutelaBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nTutelaBadBlockTime;
    unsigned int nTutelaBadBlocknBits;
