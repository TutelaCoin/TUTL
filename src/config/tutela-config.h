/* src/config/tutela-config.h.  Generated from tutela-config.h.in by configure.  */
/* src/config/tutela-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TUTL_CONFIG_H

#define TUTL_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/TutelaCoin/TUTL/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Tutela Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Tutela Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tutela"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://tutela.io/"
