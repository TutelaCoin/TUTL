...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "tutela" is a composite category enabling all Tutela-related debug output
            if (ptrCategory->count(std::string("tutela"))) {
...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\Tutela
// Windows >= Vista: C:\Users\Username\AppData\Roaming\Tutela
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "tutela.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "tutelad.pid"));
