...
const char * const PIVX_CONF_FILENAME = "tutela.conf";
const char * const PIVX_PID_FILENAME = "tutela.pid";
const char * const PIVX_MASTERNODE_CONF_FILENAME = "masternode.conf";


// Tutela only features
// Masternode
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\tutela
// Windows >= Vista: C:\Users\Username\AppData\Roaming\tutela
// Mac: ~/Library/Application Support/tutela
// Unix: ~/.tutela
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tutela";
#else
    fs::path pathRet;
...
static fs::path ZC_GetBaseParamsDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\tutelaParams
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\tutelaParams
    // Mac: ~/Library/Application Support/tutelaParams
    // Unix: ~/.tutela-params
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "TutelaParams";
#else
    fs::path pathRet;
    char* pszHome = getenv("HOME");
    if (pszHome == NULL || strlen(pszHome) == 0)
    ...
    pathRet /= "Library/Application Support";
    TryCreateDirectory(pathRet);
    return pathRet / "TutelaParams";
#else
    // Unix
    return pathRet / ".tutela-params";
#endif
#endif
}
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty tutela.conf if it does not exist
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override tutela.conf
