// Copyright (c) 2022 The Tutela Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef TUTELA_CRYPTO_GOOGLE_AUTHENTICATOR_H
#define TUTELA_CRYPTO_GOOGLE_AUTHENTICATOR_H
...
#endif // TUTELA_CRYPTO_GOOGLE_AUTHENTICATOR_H
