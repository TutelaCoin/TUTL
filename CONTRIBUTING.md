Contributing to Tutela Core
============================

The Tutela Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Tutela Core project, and is not to be
confused with overall Tutela Network Protocol consensus changes.

Whether a pull request is merged into Tutela Core rests with the project merge
...
Patches that change Tutela consensus rules are considerably more involved than
...
Where a patchset proposes to change the Tutela consensus, it must have been
...
The project leader is the release manager for each Tutela Core release.
