...
RESOURCES += src/qt/tutela.qrc src/qt/tutela_locale.qrc

TRANSLATIONS += src/qt/locale/tutela_bg.ts \
                src/qt/locale/tutela_de.ts \
                src/qt/locale/tutela_en.ts \
                src/qt/locale/tutela_es.ts \
                src/qt/locale/tutela_fi.ts \
                src/qt/locale/tutela_fr.ts \
                src/qt/locale/tutela_it.ts \
                src/qt/locale/tutela_ja.ts \
                src/qt/locale/tutela_pl.ts \
                src/qt/locale/tutela_pt.ts \
                src/qt/locale/tutela_ru.ts \
                src/qt/locale/tutela_sk.ts \
                src/qt/locale/tutela_sv.ts \
                src/qt/locale/tutela_vi.ts \
                src/qt/locale/tutela_zh_CN.ts \
                src/qt/locale/tutela_zh_TW.ts
