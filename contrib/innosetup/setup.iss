...
#define MyAppName "Tutela Core"
#define MyAppPublisher "2022 Tutela Core Developers"
#define MyAppURL "https://tutela.io/"
#define MyAppExeName "tutela-qt.exe"
#define MyAppExtraData "https://downloads.tutela.io/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=TutelaSetup
...
[Files]
Source: ".\package\tutela-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Tutela\Tutela-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Tutela\Tutela-Qt,strDataDir|{userappdata}\Tutela\}');
  Result := True;
end;
