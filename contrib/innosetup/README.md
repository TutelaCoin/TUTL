...
* Fill in the following data:
    * Application Name: `Tutela Core`
    * Application Version: `1.0.0.0`
    * Application Publisher: `2022 Tutela Core Developers`
    * Application Website: `https://github.com/TutelaCoin/TUTL`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `Tutela`
* Add application files:
    * Select the file `tutl-pt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `tutl-1.0.0.0-win64-setup.exe`
