...
# Create zip file of binaries
	cp src/tutelad.exe src/tutela-cli.exe src/tutela-tx.exe /src/qt/tutela-qt.exe .
	zip TUTL-Windows.zip tutelad.exe tutela-cli.exe tutela-tx.exe tutela-qt.exe
	rm -f tutelad.exe tutela-cli.exe tutela-tx.exe tutela-qt.exe
