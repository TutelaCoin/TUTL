...
# Create zip file of binaries
	cp src/tutelad src/tutela-cli src/tutela-tx /src/qt/tutela-qt .
	zip TUTL-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip tutelad tutela-cli tutela-tx tutela-qt
	rm -f tutelad tutela-cli tutela-tx tutela-qt
