...
The build script we'll be using is contained in the Tutela github repository ([contrib/gitian-build.py](https://github.com/TutelaCoin/TUTL/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Tutela repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/TutelaCoin/Tutela/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, tutela-detached-sigs, and tutela GitHub repos.
