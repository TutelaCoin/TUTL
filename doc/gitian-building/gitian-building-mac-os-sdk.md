...
The script [extract-osx-sdk.sh](https://github.com/TutelaCoin/TUTL/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
tutela/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/TutelaCoin/TUTL/blob/master/doc/README_osx.md) for troubleshooting tips.