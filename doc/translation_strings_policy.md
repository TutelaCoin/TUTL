...
This document provides guidelines for internationalization of the Tutela Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Tutela network</source>
        <translation>
            <numerusform>%n active connection to Tutela network</numerusform>
            <numerusform>%n active connections to Tutela network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tutela_en.ts` remains unchanged.
