...
class RawTransactionsTest(TutelaTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid tutela address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid tutela address" in e.error['message'])
