...
from test_framework.tutela_node import TutelaTestNode
...
class Tutela_ColdStakingTest(TutelaTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(TutelaTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 TUTL from the pot)
